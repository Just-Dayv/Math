...
//                    stepSize.setText(newValue.replaceAll("[^\\d+(\\.)\\d*]", ""));
    ...
    public void calculate() {
        ...
        while (percentError > epsilon) {
            midValue = ( finValue*function.calculate(initValue)-initValue*function.calculate(finValue))/(function.calculate(initValue)-function.calculate(finValue)) ;
            list.add(midValue);
            output += "\\\\";
            output += "\\\\";
...
//            if (iteration > 2)
//            {
//                percentError = calcPercentError(list.get(iteration-1),list.get(iteration-2));
//                if (percentError < epsilon)
//                    break;
//            }
            output+= String.format("For \\hspace{0.4cm} iteration \\hspace{0.4cm} %d:\\\\",iteration);
            output+= ("\\hspace{1.4cm} x_m = \\frac{x_uf(x_l)-x_lf(x_u)}{f(x_l)-f(x_u)} \\\\");
            output+="\\\\";
            output+= String.format("\\hspace{1.4cm}=\\hspace{0.4cm}\\frac{%.4f(%.8f) - %.4f(%.8f)}{%.8f -%.8f}\\\\",finValue,function.calculate(initValue),initValue,function.calculate(finValue),function.calculate(initValue),function.calculate(finValue));
            output+="\\\\";
            output += String.format("\\hspace{1.4cm} x_m\\hspace{0.4cm} = \\hspace{0.4cm} %.5f\\\\", midValue);
...
//            iteration+=1;
            ...
            if (function.calculate(midValue) == 0 ) {
                ...
                output += String.format("\\hspace{1.4cm} f(x_m)f(x_u)\\hspace{0.4cm}=\\hspace{0.4cm}f(%.5f)*f(%.5f) = \\hspace{0.4cm}%.13f \\hspace{0.4cm}which \\hspace{0.4cm}is \\hspace{0.4cm} > 0\\\\", midValue, finValue, function.calculate(midValue) * function.calculate(finValue));
                finValue = midValue;
                oldMidValue = midValue;
                output += String.format("\\hspace{1.4cm} f(x_l)f(x_m)\\hspace{0.4cm}=\\hspace{0.4cm}f(%.5f)*f(%.5f) = \\hspace{0.4cm} %.13f\\hspace{0.4cm}which \\hspace{0.4cm}is \\hspace{0.4cm} < 0\\\\", initValue, midValue, (function.calculate(midValue) * function.calculate(initValue)));
                output += String.format("\\hspace{1.4cm} Therefore\\hspace{0.4cm} a \\hspace{0.4cm} solution\\hspace{0.4cm} exists\\hspace{0.4cm}  between \\hspace{0.4cm} %.5f  \\hspace{0.4cm} and\\hspace{0.4cm}  %.5f \\\\", initValue, midValue);
             //   output += String.format("\\hspace{1.4cm} Testing\\hspace{0.4cm}  with \\hspace{0.4cm} new \\hspace{0.4cm} constraints\\hspace{0.4cm} :\\hspace{0.4cm}  %.5f, \\hspace{0.4cm} %.5f\\\\", initValue, finValue);
                ...
                oldMidValue = midValue;
                output += String.format("\\hspace{1.4cm} f(x_m)f(x_u)\\hspace{0.4cm}=\\hspace{0.4cm}f(%.5f)*f(%.5f) = \\hspace{0.4cm}%.13f \\hspace{0.4cm}which \\hspace{0.4cm}is \\hspace{0.4cm} < 0\\\\", midValue, finValue, function.calculate(midValue) * function.calculate(finValue));
                output += String.format("\\hspace{1.4cm} Therefore\\hspace{0.4cm} a \\hspace{0.4cm} solution\\hspace{0.4cm} exists\\hspace{0.4cm}  between \\hspace{0.4cm} %.5f  \\hspace{0.4cm} and\\hspace{0.4cm}  %.5f \\\\", midValue, finValue);
              //  output += String.format("\\hspace{1.4cm} Testing \\hspace{0.4cm} with \\hspace{0.4cm} new \\hspace{0.4cm} constraints\\hspace{0.4cm}:\\hspace{0.4cm}  %.5f,\\hspace{0.4cm}  %.5f\\\\", initValue, finValue);
                iteration+=1;
